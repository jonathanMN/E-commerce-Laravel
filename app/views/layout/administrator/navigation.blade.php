	...
	<div class="container">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-group"></i> Users <b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="{{ URL::route('add-users') }}">Add New User</a></li>
						<li><a href="{{ URL::route('list-users') }}">User Accounts</a></li>
					</ul>
				</li>
				<li class="dropdown">
